...
from SiamFDA.utils.bbox import center2corner, Center
from SiamFDA.datasets.point_target import PointTarget
from SiamFDA.datasets.augmentation import Augmentation
...
class FDADataset(Dataset):
    def __init__(self, epoch_num):
        super(FDADataset, self).__init__()
    ...
    def __getitem__(self, index):
        index = index + self.num // cfg.TRAIN.EPOCH * self.epoch_num
